...
const Register = () => {
  ...
  const onValidate = () => {
    ...
    if (!data.email) {
      ...
      Println("Login", "Password confirmation is required!", "warning");
      error = true;
    } else if (data.password !== data.password_confirmation) {
      Println("Login", "Password confirmation is not match!", "warning");
      error = true;
    }
        ...
        <div className="row h-100 align-items-center justify-content-center" style={styles.box}>
          <div className="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
            <div className="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
              ...
              <div className="form-floating mb-4">
                <input type="password" className="form-control" id="floatingPassword" name="password_confirmation" placeholder="Password Confirmation" defaultValue={data.password_confirmation} disabled={pressed} onChange={onChange} required autoFocus />
                <label for="floatingPassword">Password Confirmation</label>
              </div>
              <button type="submit" className="btn btn-primary py-3 w-100 mb-4" onClick={onValidate} disabled={pressed}>Sign Up</button>
