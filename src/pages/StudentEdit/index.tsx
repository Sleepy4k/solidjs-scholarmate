  ...
  const onFinish = async () => {
    ...
    await AuthService.get({
      ...
      success: (res: any) => {
        ...
        group.controls.first_name.setValue(responseData.first_name);
        group.controls.last_name.setValue(responseData.last_name);
        group.controls.email.setValue(responseData.email);
        group.controls.phone.setValue(responseData.phone);
        group.controls.date_of_birth.setValue(responseData.date_of_birth);
        group.controls.region.setValue(responseData.region);
        group.controls.register_number.setValue(responseData.register_number);
        group.controls.toefl_score.setValue(responseData.toefl_score);
        group.controls.ielts_score.setValue(responseData.ielts_score);
      },
      finally: () => {
        context.updateData('loading', false);
      }
